...
//         TweenMax.to(".grey", 1, {x: 700, rotation: 360, delay:3, id:"grey"})
                ...
                <div className="q1-part1-values-field">
                    ...
                    <table className="q1-part1-table">
                        ...
                        <tr>
                            <td>Weight</td>
                            <td>=</td>
                            <td><input type="text" name="weight" id="weight-id" onClick={this.props.hideHint}  onKeyUp={this.buttonPressedWeight}/></td>
                            <td>lbs</td>
                        </tr>
